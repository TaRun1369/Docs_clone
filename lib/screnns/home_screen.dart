...
class HomeScreen extends ConsumerWidget {
  ...
  void signOut(WidgetRef ref){
    ...
    ref.read(userProvider.notifier).update((state) => null);// ye line imp hai taki wo wapas jaa paaye login screen pe
  }
  ...
  void navigateToDocument(BuildContext context, String documentId){
    Routemaster.of(context).push('/document/$documentId');// replace mein back se wapas wahi nhi jaa sakte jaa se aaye the isliye push
